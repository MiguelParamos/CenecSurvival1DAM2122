...
public class Juego {
	...
	public static void main(String[] args) {
		...
		armasPosibles.add(new Arma("cepillo de dientes", (byte) 17));
		...
		Personaje miguel = new Personaje("Miguel P�ramos", armasPosibles.get(r.nextInt(armasPosibles.size())),
				proteccionesPosibles.get(r.nextInt(proteccionesPosibles.size())));
		Personaje juanmi1 = new Personaje("Juanmi", armasPosibles.get(r.nextInt(armasPosibles.size())),
				proteccionesPosibles.get(r.nextInt(proteccionesPosibles.size())));
		Personaje aleBarrionuevo = new Personaje("Alejandro Barrionuevo",
				armasPosibles.get(r.nextInt(armasPosibles.size())),
				proteccionesPosibles.get(r.nextInt(proteccionesPosibles.size())));

		Personaje[] personajesPosibles = { juanmi, juanmi1, eric, miguel, aleBarrionuevo };
